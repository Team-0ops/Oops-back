...
public class CategoryController {
    ...
    public ResponseEntity<BaseResponse> getCategoryList(@Parameter(hidden = true) User user) {
    ...
    public ResponseEntity<BaseResponse> searchCategoriesByName(@RequestParam("name") String searchName, @Parameter(hidden = true) User user) {
    ...
    public ResponseEntity<BaseResponse> bookmarked (@PathVariable Long categoryId, @Parameter(hidden = true) User user) {
    ...
    public ResponseEntity<BaseResponse> unbookmarked (@PathVariable Long categoryId, @Parameter(hidden = true) User user) {
