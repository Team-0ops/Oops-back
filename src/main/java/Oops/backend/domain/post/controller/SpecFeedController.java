...
public class SpecFeedController {
    ...
    public ResponseEntity<BaseResponse> getBestPostList(@Parameter(hidden = true) @AuthenticatedUser User user,
        ...
        PostResponse.PostPreviewListDto result = specFeedService.getBestPostList(user, cutoff, pageable, sort);
    ...
    public ResponseEntity<BaseResponse> getMarkedPostList(@Parameter(hidden = true) @AuthenticatedUser User user,
        ...
        PostResponse.PostPreviewListDto result = specFeedService.getPostByCategoryList(user, situation, cutoff, pageable, categoryId, sort);
    ...
    public ResponseEntity<BaseResponse> getThisWeekPostList(@Parameter(hidden = true) @AuthenticatedUser User user,
        ...
        PostResponse.PostPreviewListDto result = specFeedService.getThisWeekPostList(user, situation, cutoff, pageable, sort);
    ...
    public ResponseEntity<BaseResponse> getLastWeekPostList(@Parameter(hidden = true) @AuthenticatedUser User user,
        ...
        List<PostResponse.PostPreviewListDto> result = specFeedService.getLastWeekPostList(user, situation, cutoff, pageable, sort);
